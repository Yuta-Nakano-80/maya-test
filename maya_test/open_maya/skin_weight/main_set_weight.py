...
from maya_test.open_maya.skin_weight.modules import set_skin_weight_process

importlib.reload(get_skin_weight)
importlib.reload(set_skin_weight_process)
...
set_skin_weight_process.main(weight_info, '|ch03_000_0000_rig_model')
